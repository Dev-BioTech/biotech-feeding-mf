...
export function FeedingPlanForm({ planToEdit, onCancel, onSave }) {
  ...
  return (
    ...
    >
      {/* Header Area */}
      <div className="relative overflow-hidden rounded-2xl md:rounded-3xl group shadow-lg bg-gradient-to-r from-farm-green-900 via-farm-emerald-600 to-farm-green-800 min-h-[180px] md:h-48">
        <div 
